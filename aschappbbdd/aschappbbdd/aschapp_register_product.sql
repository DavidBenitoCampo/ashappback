...
CREATE TABLE `register_product` (
  ...
  `fk_pedido` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `register_product` VALUES (2,'bragas',180,'x','bragas perla',0,0),(3,'pantalon',60,'x','pantalon levi´s',0,0),(4,'camiseta',10,'x','camiseta nike',0,0);
...
-- Dump completed on 2021-03-18 13:36:34
